      ...
      <article className="flex flex-col items-start gap-3">
        ...
        <div className="grid w-full grid-cols-3 grid-rows-2 gap-3">
          ...
          >
            ...
            <p className="text-left text-wrap">
              Like media to boost its popularity and see how your taste impacts
              the trends.
            </p>
          </Button>
          <Button
          ...
          >
            ...
            <p className="text-left text-wrap">
              Browse by category - movies, TV shows, books, and more - all in
              one place.
            </p>
          </Button>
          <Button
          ...
          >
            ...
            <p className="text-left text-wrap">
              Engage with the community by reading and leaving reviews on your
              favorite content.
            </p>
          </Button>
        </div>
